...
export PROJECT_NAME=osscar_jupyter_docker
export MODE=dev
...
export JUPYTER_HOST_PORT=8999
export JUPYTER_CONTAINER_PORT=8888
export PYTHON=python3

###########################################################################################################
## ADD TARGETS SPECIFIC TO "osscar-jupyter-docker"
###########################################################################################################
...
lint: ## check style with flake8
	flake8 osscar_jupyter_docker
	mypy osscar_jupyter_docker
