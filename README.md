# osscar-jupyter-docker

A docker solution for OSSCAR web applications.
...
Most of the source codes of this project, `osscar-jupyter-docker` are stored in the `osscar_jupyter_docker` directory.
...
`make create-container` creates and launch the osscar_jupyter_docker container.
...
access the Jupyter Notebook service in http://localhost:8999.
